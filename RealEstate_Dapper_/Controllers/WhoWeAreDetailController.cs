...
namespace RealEstate_Dapper_Api.Controllers
{
    ...
    public class WhoWeAreDetailController : ControllerBase
    {
        ...
        public WhoWeAreDetailController(IWhoWeAreDetailRepository weAreDetailRepository)
        {
            _whoWeAreDetailRepository = weAreDetailRepository;
        }
        ...
        {
            var values = await _whoWeAreDetailRepository.GetWhoWeAreDetailAsync(id);
            return Ok(values);
        }
    }
}
